	...
	return (
		<div>
			...
			<main className='min-h-screen pt-32 flex items-center flex-col'>
				...
				<div className='mt-12 h-full w-[88.5rem]'>
					...
					<div className='mt-6 grid grid-cols-2 w-full h-full gap-6'>
						<article className='p-4 px-5 bg-lightGray247 rounded-xl'>
							...
							<main>
								<p className='mt-4 text-commonText text-lg'>
						...
						<article className='p-4 px-5 bg-lightGray247 rounded-xl'>
							<header className='flex justify-between items-center'>
								<h1 className='text-xl text-dark28 font-semibold'>
						...
						<article className='p-4 px-5 bg-lightGray247 rounded-xl'>
							<header className='flex justify-between items-center'>
								<h1 className='text-xl text-dark28 font-semibold'>Jak działa aplikacja do zbierania pieczątek?</h1>
								<FontAwesomeIcon className='h-5 text-dark28' icon={faCircleQuestion} />
							</header>
							<main>
								<p className='mt-4 text-commonText text-lg'>
