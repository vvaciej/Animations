...
export default function Home() {
	return (
		<div className='bg-white h-max w-full text-black flex justify-center relative'>
			<div className='before:w-full before:content-[""] before:fixed before:h-[90px] before:backdrop-blur before:z-10 before:top-0 before:left-0 before:opacity-95'></div>
			...
			<div className='w-full relative z-[1] mt-24 flex items-center flex-col'>
				<main className='w-[90rem] flex flex-col items-center'>
					...
					<div className='h-screen flex items-center justify-center w-[70rem] gap-x-32'>
						<section className='flex flex-col gap-y-4'>
							...
							<p className='font-medium text-xl text-commonText'>
								Pobierz naszą aplikację mobilną, zbieraj punkty i wymieniaj na nagrody! Sprawdzaj swoje punkty, odbieraj
								ekskluzywne oferty, i bądź na bieżąco z najnowszymi promocjami. Twoi klienci zasługują na wygodę obsługi
								w zasięgu ręki!
							</p>
							<button className='flex items-center text-commonText font-medium mt-3'>
								Zobacz jak to działa <FontAwesomeIcon icon={faArrowRight} className='h-4 ml-3 text-commonText' />
					...
					<div className='h-screen flex items-center justify-center w-[70rem] gap-x-32'>
						...
						<section className='flex flex-col gap-y-4'>
							...
							<p className='font-medium text-xl text-commonText'>
								Wykorzystaj potęgę naszej aplikacji do skutecznego marketingu. Wysyłaj spersonalizowane wiadomości SMS,
								przyciągaj uwagę za pomocą powiadomień push. Buduj trwałe relacje z klientami, informuj ich o promocjach
								i utrzymuj ich zaangażowanie w Twoją markę!
							</p>
							<button className='flex items-center text-commonText font-medium mt-3'>
								Zobacz jak to działa <FontAwesomeIcon icon={faArrowRight} className='h-4 ml-3 text-commonText' />
							</button>
					...
					<div className='flex justify-center flex-col'>
						...
						<div className='grid grid-cols-2 items-center gap-8 w-full mt-24'>
							...
							<section className='w-full h-72 flex flex-col gap-y-3 p-12 bg-lightGray247 rounded-lg'>
								...
								<p className='text-xl text-commonText'>
									Nasza platforma umożliwia efektywny marketing, wykorzystując powiadomienia Push, SMS oraz e-mail. Bądź
									blisko swoich klientów, informując ich o najnowszych promocjach, ekskluzywnych ofertach i
							...
							<section className='w-full h-72 flex flex-col gap-y-3 p-12 bg-lightGray247 rounded-lg'>
								...
								<p className='text-xl text-commonText'>
									Dostęp do danych i analiz pozwoli Ci lepiej zrozumieć potrzeby Twoich klientów, personalizować oferty
									i podejmować strategiczne decyzje biznesowe. Odkryj nowe możliwości dzięki naszym narzędziom
									analitycznym.
								</p>
							</section>
						</div>
				...
				<div className='mt-16 w-[80rem]'>
					...
					<div
						...
						<section className='flex text-right flex-col justify-center gap-4'>
							...
							<p className='text-xl text-commonText'>
								Wybij się na tle konkurencji. Nasza aplikacja umożliwia łatwe nagradzanie klientów za każde zamówienie,
								co zwiększa retencję i zachęca do częstszych odwiedzin. Wykorzystaj możliwości personalizacji i promuj
								swoje najpopularniejsze napoje lub przekąski jako nagrody, co skutecznie przyciągnie uwagę potencjalnych
								klientów.
							</p>
						</section>
						<img
							src='https://stamply.pl/_next/image/?url=%2Fimages%2Fcustomers%2Fcafe.jpg&w=640&q=75'
							alt=''
					...
					<div
						...
						<img
							src='https://stamply.pl/_next/image/?url=%2Fimages%2Fcustomers%2Fice-cream.jpg&w=640&q=75'
							alt=''
					...
					<div
						...
						<img
							src='https://stamply.pl/_next/image/?url=%2Fimages%2Fcustomers%2Fshop.jpg&w=640&q=75'
							alt=''
							className='h-80 rounded-xl'
						/>
					</div>
					<div
						...
						<img
							src='https://stamply.pl/_next/image/?url=%2Fimages%2Fcustomers%2Fservices.jpg&w=640&q=75'
							alt=''
							className='h-80 rounded-xl'
						/>
						<section className='flex text-left flex-col justify-center gap-4'>
							...
							<p className='text-xl text-commonText'>
								...
								relacje i zachęca do powrotu. Dzięki Stamply zbudujesz silną markę i zwiększysz zaangażowanie klientów,
								co przełoży się na wzrost sprzedaży i sukces Twojego biznesu.
							</p>
						</section>
					</div>
				</div>
